...
function createNewRelease(){
  vers=$1
  p='"'
  # x='"tag_name":$vers,"target_commitish":"master","name":$vers,"body":"Description of the release","draft":false,"prerelease":${PRERELASE},"generate_release_notes":false'
  x="${p}tag_name${p}:${p}$vers${p},${p}target_commitish${p}:${p}master${p},${p}name${p}:${p}$vers${p},${p}body${p}:${p}Description of the release${p},${p}draft${p}:false,${p}prerelease${p}:${PRERELASE},${p}generate_release_notes${p}:${AUTODESCRIPTION}"
